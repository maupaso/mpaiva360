...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "mpaiva360@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "mpaiva360 API";

        private String description = "mpaiva360 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "mpaiva360";
